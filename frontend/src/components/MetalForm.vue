...
const form = reactive({ type: PreciousMetalType.GOLD, brand: PreciousMetalBrand.ANTAM, bought_price: '', buy_price: '', buyback_price: '', weight: '' })
watch(() => props.initial, value => Object.assign(form, value || {}), { immediate: true })
